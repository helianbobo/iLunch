          ...
          <div class="cai_s">
            ...
            <input class="xuangou" onmouseover="this.className='xuangou_1'" onmouseout="this.className='xuangou'" name="" type="button" value="" />
              ...
              <div id="date_picker" class="alert_div_7" style="position:absolute;display:none;z-index:10000">
                ...
                <div class="btnbox_week" style="background:#FFF; color:#03F; text-align:center;"><a href="#" style="color:#0183C1; margin-right:30px;" onclick="lastWeek(this);">上一周</a> <a href="#" style="color:#0183C1;" onclick="nextWeek(this);">下一周</a></div>
              </div>
              <div id="sd_list">
              </div>
