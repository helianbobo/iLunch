                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="cellNumber" title="${message(code: 'person.cellNumber.label', default: 'Cell Number')}" />
                    ...
                    <g:each in="${personInstanceList}" status="i" var="personInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: personInstance, field: "cellNumber")}</td>
