...
<%@ page import="cn.ilunch.domain.UserRole" %>
<html>
    <head>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: userRoleInstance, field: 'role', 'errors')}">
                                    <g:select name="role.id" from="${cn.ilunch.domain.Role.list()}" optionKey="id" value="${userRoleInstance?.role?.id}"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: userRoleInstance, field: 'user', 'errors')}">
                                    <g:select name="user.id" from="${cn.ilunch.domain.Person.list()}" optionKey="id" value="${userRoleInstance?.user?.id}"  />
                                </td>
                            </tr>
