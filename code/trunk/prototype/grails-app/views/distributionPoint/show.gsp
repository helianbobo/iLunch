                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="distributionPointGroup" action="show" id="${distributionPointInstance?.group?.id}">${distributionPointInstance?.group?.encodeAsHTML()}</g:link></td>
